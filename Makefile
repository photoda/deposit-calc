...
bin/deposit_calc_test_validation: build/test/validation_test.o build/test/main.o build/src/deposit.o
	...
	gcc -I thirdparty build/test/main.o build/test/validation_test.o build/src/deposit.o -o bin/deposit_calc_test_validation   
 
bin/deposit_calc_test: build/test/deposit_test.o build/test/main.o build/src/deposit.o

	gcc -I thirdparty build/test/main.o build/test/deposit_test.o build/src/deposit.o -o bin/deposit_calc_test
...
build/test/validation_test.o: test/validation_test.c
	gcc -Wall -Werror -I thirdparty -c test/validation_test.c -o build/test/validation_test.o

build/test/main.o: test/main.c
	gcc -Wall -Werror  -I thirdparty -c test/main.c -o build/test/main.o

build/src/main.o: src/main.c
	gcc -Wall -Werror -I thirdparty -c src/main.c -o build/src/main.o

build/src/deposit.o: src/deposit.c
	gcc -Wall -Werror -I thirdparty -I src -c src/deposit.c -o build/src/deposit.o
